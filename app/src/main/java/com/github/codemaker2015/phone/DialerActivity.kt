...
//        }
    ...
    public fun updateText(view : View) {
        ...
        phoneNumberInput.setText(phoneNumberInput.text.toString() + buttonText)
    }

    public fun clearText() {
        var text = phoneNumberInput.text.toString()
        if(text != null && text.length > 0)
            phoneNumberInput.setText(phoneNumberInput.text.toString().substring(0, text.length-1))
    }
}
